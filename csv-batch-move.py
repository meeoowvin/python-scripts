...
def move_files_to_folders(split_csv_folder, all_attachments_folder):
    # Create the "Attachments" folder if it doesn't exist
    attachments_folder = "Attachments-Moved"
    ...
    for csv_file_name in os.listdir(split_csv_folder):
        if csv_file_name.endswith(".csv"):
            ...
            # Read the CSV and move files listed in the "File Name" column
            with open(csv_file_path, mode="r", newline="") as csv_file:
                ...
                for row in csv_reader:
                    ...
                    if os.path.exists(source_file_path):
                        ...
                        # Move the file to the folder for this CSV
                        destination_file_path = os.path.join(folder_path, file_name)
                        shutil.move(source_file_path, destination_file_path)

            # Move the completed CSV to the root folder of the "Attachments" folder
            destination_csv_path = os.path.join(attachments_folder, csv_file_name)
...
def main():
    ...
    move_files_to_folders(split_csv_folder, all_attachments_folder)
