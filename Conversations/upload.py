...
# Open Chrome and navigate to the data import page
chrome_path = r'C:\Program Files\Google\Chrome\Application\chrome.exe'  # Update with your Chrome path
data_import_url = 'https://sdpondemand.manageengine.com/app/itdesk/AdminDetails.cc?forwardTo=dataImport'
profile_directory = 'Profile 1'  # Update with your profile directory
...
pyautogui.write(f'"{chrome_path}" --profile-directory="{profile_directory}"')
